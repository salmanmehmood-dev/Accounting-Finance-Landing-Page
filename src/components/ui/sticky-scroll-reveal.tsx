...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="h-[30rem] overflow-y-auto flex justify-center relative space-x-10 rounded-md p-10 scrollbar-hide my-10"
      ref={ref}
    >
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="my-20">
              ...
              <motion.p
                ...
                className="text-kg text-muted-foreground max-w-sm mt-10 leading-relaxed"
              >
                {item.description}
              </motion.p>
            </div>
